        ...
        if (feature == "all") {
            ...
            try {
                ...
                let teks = res.map((item, index) => {
                    return `�9�3 *[ RESULT ${index + 1} ]*

�9�2 Title: ${item.title}
�9�3 Link: ${decodeURIComponent(item.link)}
�9�5 Date: ${item.date}
  `
...
�9�2 Title: ${item.title}
�9�8�1�5 Image: ${item.image}
�9�5 Caption: ${item.caption}
�7�1�1�5 Author: ${item.author}
�9�1 Date: ${item.date}
�9�4 Content: ${item.content}
�9�2 Tags: ${item.tags}
`
...
handler.command = /^(اخبار|الاخبار)$/i
